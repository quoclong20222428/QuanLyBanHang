...
namespace QUANLYBANHANG
{
    public partial class frmDanhMucKhachHang : Form
    {
        ...
        private void txtMaKhach_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                errorProvider1.SetError(txtMaKhach, "Mã không được phép có khoảng trắng, các ký tự đặc biệt!");
            }
        }
        ...
        private void txtTenKhach_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = false;
                errorProvider1.SetError(txtTenKhach, "Không để dư khoảng trắng đầu và cuối");
            }
        }
